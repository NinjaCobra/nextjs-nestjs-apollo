...
const Login = ({ setCorsErrorModalOpen }) => {
  ...
  useEffect(() => {
    ...
    const widget = new ninjaSignIn({
      /**
       * Note: when using the Sign-In Widget for an OIDC flow, it still
       * needs to be configured with the base URL for your ninja Org. Here
      ...
      authParams: {
        // To avoid redirect do not set "pkce" or "display" here. ninja-335945
        issuer,
        scopes,
      },
