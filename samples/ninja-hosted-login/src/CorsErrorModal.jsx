...
const CorsErrorModal = ({ corsErrorModalOpen, setCorsErrorModalOpen }) => {
  ...
  const guideUrl = 'https://developer.ninja.com/docs/guides/enable-cors/granting-cors/';
      ...
      <Modal.Content>
        <Modal.Description>
          ...
          <p>
            ...
            {' '}
            <a href={corsAdminUrl} target="_blank" rel="noreferrer">ninja Administrator Dashboard</a>
          </p>
          <p>
            Read
            {' '}
