...
const Messages = () => {
  ...
  useEffect(() => {
    if (authState && authState.isAuthenticated) {
      const accessToken = ninjaAuth.getAccessToken();
  ...
  const possibleErrors = [
    ...
    'Your resource server example is using the same ninja authorization server (issuer) that you have configured this React application to use.',
  ];
