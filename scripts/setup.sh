...
if [ ! -z "$AUTHJS_VERSION" ]; then
  ...
  # modifies the package.json of all workspaces depending on @ninja/ninja-auth-js to point to the upstream version
  ...
  AUTHJS_INSTALLS=$(find . -type d -path "*/node_modules/@ninja/ninja-auth-js" -not -path "*/ninja-signin-widget/*" | wc -l)
