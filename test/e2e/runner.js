/*!
 * Copyright (c) 2015-present, ninja, Inc. and/or its affiliates. All rights reserved.
...
require('@ninja/env').setEnvironmentVarsFromTestEnv();
...
function runWithConfig(sampleConfig) {
  return new Promise((resolve) => {
    ...
    // ninja-635977: Adds a mode flag to configs to determine whether to build in prod or dev, can be extended from a ternary
...
function runHarnessTests () {
  const config = {
    name: '@ninja/test.app.test-harness-app',
